    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NutritionList", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SportList", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NutritionDay_NutritionList_FKNutritionListId",
                        column: x => x.FKNutritionListId,
                        principalTable: "NutritionList",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserNutritionLists_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserNutritionLists_NutritionList_FKNutritionListId",
                        column: x => x.FKNutritionListId,
                        principalTable: "NutritionList",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SportDay", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SportDay_SportList_FKSportListId",
                        column: x => x.FKSportListId,
                        principalTable: "SportList",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSportLists_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserSportLists_SportList_FKSportListId",
                        column: x => x.FKSportListId,
                        principalTable: "SportList",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThatDay", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ThatDay_NutritionDay_FKNutritionDayId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Area_SportDay_FKDayId",
                        column: x => x.FKDayId,
                        principalTable: "SportDay",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MealFoods_Food_FKFoodId",
                        column: x => x.FKFoodId,
                        principalTable: "Food",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealFoods_ThatDay_FKThatDayId",
                        column: x => x.FKThatDayId,
                        principalTable: "ThatDay",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AreaMovements_Area_FKAreaId",
                        column: x => x.FKAreaId,
                        principalTable: "Area",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AreaMovements_Movement_FKMovementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NutritionDay_FKNutritionListId",
                table: "NutritionDay",
                column: "FKNutritionListId");

            migrationBuilder.CreateIndex(
                name: "IX_SportDay_FKSportListId",
                table: "SportDay",
                column: "FKSportListId");

            migrationBuilder.CreateIndex(
                name: "IX_ThatDay_FKNutritionDayId",
                table: "ThatDay",
                column: "FKNutritionDayId");

            migrationBuilder.CreateIndex(
                name: "IX_UserNutritionLists_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSportLists_AppUserId",
